  ...
  <div id="auth-channel" class="auth-channel">
    <el-container>
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column prop="name" label="渠道名称" sortable align="center">
          </el-table-column>
          <el-table-column
            prop="introduce"
            label="渠道说明"
    ...
    >
      ...
      >
        ...
        <el-form-item label="渠道说明" prop="introduce">
          <el-input
            type="textarea"
            :rows="4"
            show-word-limit
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        introduce: [
          { required: true, message: "渠道说明不能为空", trigger: "blur" },
          {
            min: 1,
            max: 100,
            message: "最多100个字符",
  ...
  methods: {
    ...
    handleEdit(index, row) {
      console.log(index, row);
      this.dialogTitle = "渠道修改";
      this.form = JSON.parse(JSON.stringify(row));
      this.dialogVisible = true;
    },
    handleAdd() {
      this.dialogTitle = "渠道添加";
      this.dialogVisible = true;
    },
    submitForm(formName) {
